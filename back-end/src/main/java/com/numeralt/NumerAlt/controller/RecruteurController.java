...
import com.numeralt.NumerAlt.service.RecruteurServiceInterface;
...
public class RecruteurController {
    ...
    @Autowired
    private RecruteurServiceInterface recruteurService;
    ...
    public UserDto registerRecruteurAccount(@RequestBody @Valid UserDto userDto) {
        try {
            Recruteur registered = recruteurService.registerNewRecruteurAccount(userDto);
        } catch (Exception e) {
